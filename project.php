<?php
// Dynamic project page — mirrors project.html but loads portfolio items from DB
...
<?php
// Load portfolio items from DB; preserve original markup
...
if ($portfolio_q && $portfolio_q->num_rows > 0) {
    while ($p = $portfolio_q->fetch_assoc()) {
        ...
        ?>
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item <?php echo $catClass; ?>">
              <div class="portfolio-content h-100">
                <img src="assets/img/portfolio/<?php echo $img; ?>" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><?php echo $title; ?></h4>
                  <p><?php echo $desc; ?></p>
                  <a href="assets/img/portfolio/<?php echo $img; ?>" title="<?php echo $title; ?>" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="portfolio-details.php?id=<?php echo $pid; ?>" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div>
    ...
    // fallback: include the static items from original HTML to keep appearance
    $static_port = [
        ['img' => 'assets/img/portfolio/2.jpg','title'=>'App 1','category'=>'App','href'=>'assets/img/portfolio/2.jpg','desc'=>'Lorem ipsum, dolor sit amet consectetur'],
        ['img' => 'assets/img/portfolio/Picture1.png','title'=>'Product 1','category'=>'Product','href'=>'assets/img/portfolio/Picture1.png','desc'=>'Lorem ipsum, dolor sit amet consectetur'],
        ['img' => 'assets/img/portfolio/Picture4.png','title'=>'Branding 1','category'=>'Branding','href'=>'assets/img/portfolio/Picture4.png','desc'=>'Lorem ipsum, dolor sit amet consectetur'],
    ];
    foreach ($static_port as $p) {
        ?>
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <img src="<?php echo $p['img']; ?>" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><?php echo $p['title']; ?></h4>
                  <p><?php echo $p['desc']; ?></p>
                  <a href="<?php echo $p['href']; ?>" title="<?php echo $p['title']; ?>" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
